...
import com.making.making_a_habit.databinding.DetailsDonehabitPageBinding
import com.making.making_a_habit.model.Habit
import com.making.making_a_habit.view.dialog.deleteDialogFragment
import com.making.making_a_habit.viewmodel.DetailDonehabitViewModel
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                runOnUiThread {
                    ...
                    when(habit.habitColor){  // habitColor theme 설정
                        ...
                        "gray" -> {
                            binding.habitNameTextDetailshabitpage.setTextColor(Color.parseColor("#AAAAAA"))
